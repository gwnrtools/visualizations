...
# Copyright (c) 2024, Bhuvaneshwari Kashi
# See LICENSE file for details: <https://github.com/gwnrtools/visualizations/blob/master/LICENSE>
...
if __name__ == "__main__":
    ...
    setup(
        name=NAME,
        version=VERSION,
        description="A collection of tools to visualize and animate various modes of gravitational waves",
        long_description=get_long_description(),
        license="GPL",
        url="https://github.com/gwnrtools/visualizations",
        author="Bhuvaneshwari Kashi",
        author_email="bhuvana9kashi@gmail.com",
